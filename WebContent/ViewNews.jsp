	...
	<div class="panel panel-default">
    	...
    	<form action="AnnouncementController" role="form" method="post">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="txtNews">News:</label>
					<div class="col-sm-10">
					<textarea class="form-control" name="txtNews" placeholder="Enter Event Information"></textarea><br>
				</div>
				</div>
				<div class="form-group">
				...
				<div class="col-sm-4"></div>
  				<div class="col-sm-4">
  					...
  					<input type="hidden" name="flag" value="AddNews">
  				</div>
  				</div>
		</form>
		</div>
