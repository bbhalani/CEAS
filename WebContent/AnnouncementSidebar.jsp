...
<title>AnnouncementSidebar</title>
    ...
    <div id="sidebar-wrapper">
		<ul class="sidebar-nav">
    	    <li class="sidebar-brand">
            	<a href="AnnouncementController?flag=ViewEvent">
            	View Events
            	</a>
           	</li>
           	<li class="sidebar-brand">
           		<a href="AnnouncementController?flag=ViewJobs">View Jobs</a>
            </li>
            <li class="sidebar-brand">
                <a href="AnnouncementController?lag=ViewNews">View News</a>
            </li>
		</ul>
    </div>
</div>
