...
{
	document.forms["addcourseinfoform"].submit();
}
 */
</script>
...
<jsp:include page="CourseSidebar.jsp"></jsp:include>
	<div class="container">
	<h1>Update My Course Info</h1>
	<div class="panel panel-default">
    <div class="panel-body">
  
		<form action="CourseController" role="form" method="post">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="ddlCourseNo">Course NO:</label>
					<div class="col-sm-10">
					<div>
    					
    					<select class="form-control" name="CourseNo">
    					<option>Select Course</option>
    					<c:forEach var="CourseNo" items="${sessionScope.CourseNo}">
      					<option value="${CourseNo.courseno}">${CourseNo.courseno}</option>
      					</c:forEach>
      				    </select>
  					</div><br>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="txtCourseDescription">Course Information:</label>
					<div class="col-sm-10">
					<textarea class="form-control" name="txtCourseDescription" placeholder="Course Description"></textarea><br>
					</div>
				</div>
			</div>
			<div class="form-group">
  				<div class="col-sm-12">
  					...
  					<input type="hidden" name="flag" value="UpdateMyCourseInfo">
  				</div>
  				</div>
		</form>
		</div>	
