	...
	<div class="panel panel-default">
    	...
    	<form action="AnnouncementController" role="form" method="post">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="txtJob">Job Information:</label>
					<div class="col-sm-10">
					<textarea class="form-control" name="txtJob" placeholder="Enter Event Information"></textarea><br>
				</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="txtLink">Link</label>
					<div class="col-sm-10">
					<input type="text" class="form-control" name="txtLink" placeholder="Enter link"></textarea><br>
				</div>
				</div>
				<div class="form-group">
				<div class="col-sm-4"></div>
  				<div class="col-sm-4">
  					...
  					<input type="hidden" name="flag" value="AddJob">
  				</div>
  				</div>
		</form>
		</div>
