    ...
    <div id="sidebar-wrapper">
		<ul class="sidebar-nav">
    	    <li class="sidebar-brand">
                    <a href="DiscussionBoard.jsp">Post a New Discussion topic </a>
                </li>
                <li class="sidebar-brand">
                    <a href="DiscussionBoardController?flag=ViewDiscussion">View Discussions</a>
                </li>
		</ul>
    </div>
</div>
